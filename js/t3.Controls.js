 ...
 * @modified Titus Chatzis / http://www.tituschatzis.com/
*/

t3.Controls = function()
{
    var args = arguments[ 0 ];

    this.object = args.object;
    this.domElement = args.parent;
    this.domElement.setAttribute( 'tabindex', -1 );
    this.autoForward = args.autoForward;
    ...
    this.keydown = function( event )
    {
        ...
        {
            case 27: /* esc */ this.disabled = !this.disabled; break;
    ...
    {
        var animation = t3.utils.search( { type: 'animations', filter: [ { name: 'rotate' }, { index: 0 } ] } );
    ...
    {
        this.movementSpeedMultiplier -= event.deltaY / 100;
    };
    ...
    {
        var forward = ( this.moveState.forward || this.autoForward ) ? 1 : 0;
    ...
    this.dispose = function()
    {
        ...
        this.domElement.removeEventListener( 'click', _wheel, false );
    ...
    var _click = bind( this, this.click );
    ...
    this.domElement.addEventListener( 'click', _click, false );
